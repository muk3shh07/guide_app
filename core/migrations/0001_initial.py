    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area_type', models.CharField(choices=[('open', 'Open Area'), ('restricted', 'Restricted Area')], default='open', max_length=20)),
                ('description', models.TextField(blank=True, null=True)),
                ('latitude', models.DecimalField(blank=True, decimal_places=6, max_digits=9, null=True)),
                ('longitude', models.DecimalField(blank=True, decimal_places=6, max_digits=9, null=True)),
                ('permit_required', models.BooleanField(default=False)),
                ('permit_cost', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('best_season', models.JSONField(blank=True, default=list)),
                ('difficulty_level', models.CharField(choices=[('easy', 'Easy'), ('moderate', 'Moderate'), ('difficult', 'Difficult'), ('extreme', 'Extreme')], default='easy', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('user_type', models.CharField(choices=[('tourist', 'Tourist'), ('guide', 'Freelance Guide'), ('agency', 'Agency'), ('admin', 'Admin')], default='tourist', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_license', models.FileField(blank=True, null=True, upload_to='company_licenses/')),
                ...
                ('managed_guides', models.ManyToManyField(blank=True, to='core.guide')),
            ],
        ),
        migrations.CreateModel(
            name='Tourist',
